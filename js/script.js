...
class App extends React.Component {
  ...
  result() {
    ...
    if (
      ...
      && (list.childNodes.length === 0 || list.lastChild.innerHTML !== this.format(this.state.times))
    ) {
    ...
    return (
      <div className="container">
        ...
        <div className="results-wrapper">
          ...
          <button className="button" id="clear" onClick={() => { document.querySelector('.results').innerHTML = '' }}>Clear</button>
        </div>
      </div>
    );
  }
